...
def plot_metrics(metrics, save_path: str = 'metrics.png'):
    ...
    ax1.bar(metric_names, metric_values, color=colors, edgecolor='white', linewidth=2)
    ax1.set_ylim(0, 1)
    ...
    ax2.fill(angles, values, color='#667eea', alpha=0.25)
    ax2.plot(angles, values, color='#667eea', linewidth=2)
