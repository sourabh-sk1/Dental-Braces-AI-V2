...
def load_model(weights_path: str = 'runs/detect/train_final/weights/best.pt'):
    """
...
Examples:
  ...
  python detect.py --image path/to/image.jpg --show
    ...
    parser.add_argument(
        '--weights', '-w',
        type=str,
        default='runs/detect/train_final/weights/best.pt',
        help='Path to model weights (default: runs/detect/train_final/weights/best.pt)'
    )
