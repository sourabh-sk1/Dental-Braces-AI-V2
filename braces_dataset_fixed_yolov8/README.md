...
- `runs/detect/train_final/weights/best.pt` (best model)
- `runs/detect/train_final/weights/last.pt` (last checkpoint)
...
python detect.py --image path/to/image.jpg --weights runs/detect/train_final/weights/best.pt
```
